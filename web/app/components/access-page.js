...
function LoginForm() {
    ...
    return html`
        ...
        <div class="oauth-providers">
            <a class="btn" href="/api/github_auth?redirect_uri=${encodeURIComponent(location.origin + "/access-callback")}" data-default="true">
            ...
            <a class="btn" href="/api/google_auth?redirect_uri=${encodeURIComponent(location.origin + "/access-callback")}" data-default="true">
